    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-150">
          <div
            className="relative w-full max-w-3xl rounded-2xl border border-chaan-border bg-chaan-card text-white shadow-2xl p-6 sm:p-7 space-y-6 overflow-hidden max-h-[90vh] overflow-y-auto"
          ...
          >
            ...
            <div className="space-y-4">
              {/* GREEN FLAG CARD */}
              <div className="rounded-2xl border border-emerald-800/60 bg-gradient-to-b from-emerald-950/40 to-slate-900/60 p-5 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  {flagCounts && (
                    <span className="text-xs font-mono font-bold text-emerald-400 px-2.5 py-0.5 rounded-full bg-emerald-950 border border-emerald-800">
                ...
                <div className="space-y-1 text-xs">
                  <span className="font-semibold text-slate-200 block">Differentiating Criteria:</span>
                ...
                <div className="pt-2.5 border-t border-emerald-900/60 text-[11px] font-mono text-emerald-300 space-y-0.5">
                  ...
                  <p className="text-slate-400 text-[10px]">Normal invoice payment terms apply under Section 15 of MSMED Act, 2006.</p>
                </div>
              </div>

              {/* AMBER FLAG CARD */}
              <div className="rounded-2xl border border-amber-800/60 bg-gradient-to-b from-amber-950/40 to-slate-900/60 p-5 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                  ...
                  {flagCounts && (
                    <span className="text-xs font-mono font-bold text-amber-400 px-2.5 py-0.5 rounded-full bg-amber-950 border border-amber-800">
                ...
                <div className="pt-2.5 border-t border-amber-900/60 text-[11px] font-mono text-amber-300 space-y-0.5">
                  ...
                  <p className="text-slate-400 text-[10px]">L1 WhatsApp and Email soft statements scheduled ahead of invoice due dates.</p>
                </div>
              </div>

              {/* RED FLAG CARD */}
              <div className="rounded-2xl border border-rose-800/60 bg-gradient-to-b from-rose-950/40 to-slate-900/60 p-5 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                  ...
                  {flagCounts && (
                    <span className="text-xs font-mono font-bold text-rose-400 px-2.5 py-0.5 rounded-full bg-rose-950 border border-rose-800">
                ...
                <div className="pt-2.5 border-t border-rose-900/60 text-[11px] font-mono text-rose-300 space-y-0.5">
                  <p>⛔ <strong>Statutory Credit Policy:</strong> Auto-credit approval blocked (₹0 sanctioned limit). Enforce 100% advance payment.</p>
                  <p className="text-slate-400 text-[10px]">For existing overdue invoices, trigger immediate L3 statutory legal notice or MSMED §16 arbitration.</p>
                </div>
              </div>
            </div>

            {/* Modal Footer */}
            <div className="flex items-center justify-between pt-4 border-t border-chaan-border text-xs text-slate-400">
