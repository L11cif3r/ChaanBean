  ...
  return (
    <div className="space-y-6">
      ...
      <div className="max-w-xl mx-auto rounded-2xl border border-chaan-border bg-chaan-card p-6 lg:p-8 shadow-xl text-center space-y-5">
        ...
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-rose-500/10 border border-rose-500/30 text-[#FC8019]">
          <ShieldCheck size={32} />
        </div>
        ...
        >
          <div>
            ...
            <div className="flex items-center rounded-xl border border-slate-700 bg-slate-900 overflow-hidden focus-within:border-[#FC8019] focus-within:ring-1 focus-within:ring-[#FC8019] transition shadow-inner">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#FC8019] py-3 text-xs font-bold text-white hover:bg-[#E26D0A] disabled:opacity-50 transition shadow-md"
          >
            {loading ? (
              <>
          ...
          <div className="flex flex-wrap gap-1.5">
            {["TRUST-CB-ACME-001", "VTID-1000", "VTID-1001", "VTID-2004"].map((chip) => (
              <button
                ...
                className="rounded-lg border border-slate-700/70 bg-slate-800/60 px-2 py-1 text-[11px] font-mono text-[#FFA34D] hover:bg-slate-800 hover:border-[#FC8019] transition"
              >
                {chip}
              </button>
            ))}
        ...
        <div className="max-w-3xl mx-auto rounded-2xl border border-emerald-700/60 bg-chaan-card p-6 lg:p-8 shadow-2xl space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-[#FC8019] px-5 py-2 text-xs font-semibold text-white hover:bg-[#E26D0A] transition shadow-md"
            >
              <Download size={14} />
